---
title: "Asymptotic Normality under normal measurement errors"
...
It generates the errors for correlated and uncorrelated normal errors
...
errors<-function(xi,sigma){#generates a list of errors and their variances
  ...
  eps<-c()
  for(i in 1:n){
    temp<-rmvnorm(samp,mean=c(0,0),sigma=matrix(c(sigmadeltas[i],sigmaepsdelta[i],sigmaepsdelta[i],sigmaeps[i]),nrow=2,ncol=2))
